...
static struct map_info_type map_info[] = {{SECT_INSIDE,       "\tc[\tn.\tc]\tn"}, /* 0 */
                                          {SECT_CITY,         "\tc[\twC\tc]\tn"},
                                          {SECT_FIELD,        "\tc[\tg,\tc]\tn"},
...
static struct map_info_type world_map_info[] = {{SECT_INSIDE,       "\tn."}, /* 0 */
                                                {SECT_CITY,         "\twC"},
                                                {SECT_FIELD,        "\tg,"},
                                                {SECT_FOREST,       "\tgY"},
                                                {SECT_HILLS,        "\tMm"},
