...
#include "db.h"
#include "constants.h"
#include "olc_zone_generic.h" /* for zone_rnum real_zone_by_thing */
...
static const struct wld_command_info wld_cmd_info[] = {{"RESERVED",     0,            0},/* this must be first -- for specprocs */
